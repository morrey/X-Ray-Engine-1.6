...
void __stdcall Skin1W_SSE(vertRender*		D,
	vertBoned1W*	S,
	u32				vCount,
	CBoneInstance*	Bones)
{
...
void __stdcall Skin2W_SSE(vertRender*		D,
	vertBoned2W*	S,
	u32				vCount,
	CBoneInstance*	Bones)
{
...
void __stdcall Skin3W_SSE(vertRender*		D,
	vertBoned3W*	S,
	u32				vCount,
	CBoneInstance*	Bones)
{
...
void __stdcall Skin4W_SSE(vertRender*		D,
	vertBoned4W*	S,
	u32				vCount,
	CBoneInstance*	Bones)
{
