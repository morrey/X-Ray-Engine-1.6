...
Directory Layout:
	...
	InternParticleData.txt
	InternParticleExample.txt
		See these files for a description of the user data block
		that Maya creates for rendering particles with mental ray.
